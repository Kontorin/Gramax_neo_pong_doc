...
Программа совместима с Windows 10 и выше

Для запуска программы необходимо установить следующее ПО:

1. **Python** -- версия 3.8 и выше
...
-  **Оперативная память** -- минимум 512 МБ свободной оперативной памяти

-  **Видеокарта** -- интегрированная или дискретная видеокарта
...
-  Клавиатура с блоком стрелок (требуется для управления ракетками)
